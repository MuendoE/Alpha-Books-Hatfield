...
`index.html`, `sell.html`, `order.html`, `thanks.html`, `condition.html`, `styles.css`, `app.js`, `books.js`, `DEPLOY.md`
...
- In `app.js`, set `SITE.returnUrl` and `SITE.cancelUrl` to your Firebase address,
  e.g. `https://alpha-books-hatfield.web.app/thanks.html` and `.../index.html`
- In `app.js`, set your PayFast `merchantId` and `merchantKey`
- In `sell.html`, `order.html`, `thanks.html`, set the Formspree form IDs
- Set your email in the footers
